<?php
// SMSC.RU API (www.smsc.ru) версия 2.7 (07.06.2012)

define("SMSC_LOGIN", "Ar4ibald");		// логин клиента
define("SMSC_PASSWORD", "Pr0st@t@");	// пароль или MD5-хеш пароля в нижнем регистре
...
function send_sms($phones, $message, $translit = 0, $time = 0, $id = 0, $format = 0, $sender = "Masterskaya", $query = "")
{
	//return array(1 => 1);
